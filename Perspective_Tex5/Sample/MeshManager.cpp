...
void CMeshManager::Init_MeshManager(HWND hWnd)
{
	...
	Read_BMP_File("texture1.bmp", 0);
	Read_BMP_File("texture2.bmp", 1);
	Read_BMP_File("texture3.bmp", 2);
...
bool CMeshManager::Read_BMP_File(char *filename, int tile)
{
	FILE *fp;
