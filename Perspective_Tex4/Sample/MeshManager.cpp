...
void CMeshManager::Draw_MeshManager2()
{
	...
	for (UINT i = 0; i < m_TriangleCount; i++)
	{
		...
		tex_coord2 TexIn1 = m_TexCoord[m_IndexBuff[i * 3 + 0]];
		tex_coord2 TexIn2 = m_TexCoord[m_IndexBuff[i * 3 + 1]];
		tex_coord2 TexIn3 = m_TexCoord[m_IndexBuff[i * 3 + 2]];
		...
		Draw_Textured_Triangle(Vec1, TexIn1, Vec2, TexIn2, Vec3, TexIn3);
	}
